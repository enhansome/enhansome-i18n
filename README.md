...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,892 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-24 - readable, automated, and optimized internationalization
...
* [next-intl](https://github.com/amannn/next-intl) ⭐ 4,373 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-24 - minimal solution for internationalization in Next.js
...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,064 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-24 - component translation for Next.js with SSR/SSG
...
* (Angular) [ngx-translate](https://github.com/ngx-translate/core) ⭐ 4,662 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-23 - i18n for Angular
* (VueJS) [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,712 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-24 - i18n for VueJS
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,283 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-24 - i18n for Angular
* (Svelte) [svelte-i18n](https://github.com/kaisermann/svelte-i18n) ⭐ 1,378 | 🐛 74 | 🌐 TypeScript | 📅 2024-10-21 - i18n for Svelte
* (Nuxt) [nuxt-i18n-micro](https://github.com/s00d/nuxt-i18n-micro) ⭐ 251 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 - strategy-based i18n; @i18n-micro packages for vue/react/preact/solid/astro/node
...
[Add your links here](https://github.com/oh-jon-paul/awesome-i18n/issues/new) ⭐ 410 | 🐛 1 | 📅 2026-09-18

### Java

* (image) [Java time classes](https://github.com/oh-jon-paul/awesome-i18n/blob/main/time-api.png) ⭐ 410 | 🐛 1 | 📅 2026-09-18 - table with date-time classes
...
* [Twitter/CLDR](https://github.com/twitter/twitter-cldr-rb) ⭐ 691 | 🐛 13 | 🌐 Ruby | 📅 2025-12-18 - ICU implementation that uses the CLDR to format dates, plurals
...
* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,284 | 🐛 120 | 🌐 C++ | 📅 2026-09-24 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,088 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - cross-platform app that automatically translate texts when copied
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,812 | 🐛 127 | 🌐 Python | 📅 2026-09-03 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,457 | 🐛 30 | 🌐 Java | 📅 2026-09-23 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,506 | 🐛 162 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
* [i18n-ally](https://github.com/antfu/i18n-ally) ⭐ 4,895 | 🐛 476 | 🌐 TypeScript | 📅 2024-12-13 - VS Code extension for i18n
...
* [Shipi18n](https://github.com/Shipi18n/shipi18n) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-24 - ci linter for locale files: key/placeholder/plural checks + optional llm mistranslation pass; json, po, xliff, arb, xcstrings
