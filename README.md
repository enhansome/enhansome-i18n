...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,064 | 🐛 127 | 🌐 TypeScript | 📅 2026-09-26 - component translation for Next.js with SSR/SSG
...
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,282 | 🐛 151 | 🌐 TypeScript | 📅 2026-09-26 - i18n for Angular
* (Svelte) [svelte-i18n](https://github.com/kaisermann/svelte-i18n) ⭐ 1,378 | 🐛 74 | 🌐 TypeScript | 📅 2024-10-21 - i18n for Svelte
* (Nuxt) [nuxt-i18n-micro](https://github.com/s00d/nuxt-i18n-micro) ⭐ 252 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-26 - strategy-based i18n; @i18n-micro packages for vue/react/preact/solid/astro/node
...
* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,289 | 🐛 120 | 🌐 C++ | 📅 2026-09-24 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,856 | 🐛 128 | 🌐 Python | 📅 2026-09-03 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,459 | 🐛 30 | 🌐 Java | 📅 2026-09-26 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,511 | 🐛 162 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
