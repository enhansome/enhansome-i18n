...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,891 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-23 - readable, automated, and optimized internationalization
...
* [typesafe-i18n](https://github.com/ivanhofer/typesafe-i18n) ⭐ 2,475 | 🐛 42 | 🌐 TypeScript | 📅 2026-03-22 - type-safe, lightweight localization library for TypeScript with no external dependencies

* [messageformat](https://github.com/messageformat/messageformat) ⭐ 1,770 | 🐛 17 | 🌐 TypeScript | 📅 2026-06-29 - ICU MessageFormat for JavaScript, plural and gender capable messages
...
* [eo-locale](https://github.com/ibitcy/eo-locale) ⭐ 347 | 🐛 14 | 🌐 TypeScript | 📅 2024-12-10 - elegant lightweight library based on internationalization API

* [schummar-translate](https://github.com/schummar/schummar-translate) ⭐ 136 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-08 - TypeScript powered translation library for React and Node.js

* [intljulep](https://github.com/laurentpayot/intljulep) ⭐ 16 | 🐛 0 | 🌐 JavaScript | 📅 2024-05-30 - super lightweight yet powerful i18n library

* [BidiLens](https://github.com/CodeinScrubs/BidiLens) ⭐ 11 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-21 - per-block rtl/ltr direction and inline isolation without rewriting source text
...
* [bazi-terms](https://github.com/favkit/bazi-kit) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07 - bilingual (zh/en) bazi & four-pillars terminology database with a translate() helper

* [zero-intl](https://github.com/zero-intl/zero-intl) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-14 - dead simple library for modern apps

* [locale-lint](https://github.com/francisojeah/locale-lint) ⭐ 0 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15 - detect missing keys, unused translations, hardcoded strings, interpolation mismatches

* [locakit](https://github.com/berkayyalcin7/locakit) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-04 - i18n engine for key diffing, lockfile staleness tracking, placeholder, glossary checks
...
* [next-intl](https://github.com/amannn/next-intl) ⭐ 4,374 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-21 - minimal solution for internationalization in Next.js
...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,064 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-23 - component translation for Next.js with SSR/SSG
...
* [react-i18nify](https://github.com/sealninja/react-i18nify) ⭐ 154 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-21 - simple i18n translation and localization components and helpers for React
...
* [react-i18n-mini](https://github.com/SanichKotikov/react-i18n-mini) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2024-01-09 - tiny (\~2.39 kB) internationalisation library for React
...
* (Angular) [ngx-translate](https://github.com/ngx-translate/core) ⭐ 4,661 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-23 - i18n for Angular
* (VueJS) [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,711 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-22 - i18n for VueJS
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,281 | 🐛 160 | 🌐 TypeScript | 📅 2026-09-22 - i18n for Angular
* (Svelte) [svelte-i18n](https://github.com/kaisermann/svelte-i18n) ⭐ 1,378 | 🐛 74 | 🌐 TypeScript | 📅 2024-10-21 - i18n for Svelte
* (Nuxt) [nuxt-i18n-micro](https://github.com/s00d/nuxt-i18n-micro) ⭐ 251 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-22 - strategy-based i18n; @i18n-micro packages for vue/react/preact/solid/astro/node
* (Angular) [ng-extract-i18n-merge](https://github.com/daniel-sc/ng-extract-i18n-merge) ⭐ 222 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 - manage translation files for native Angular CLI i18n
...
[Add your links here](https://github.com/oh-jon-paul/awesome-i18n/issues/new) ⭐ 409 | 🐛 0 | 📅 2026-09-18

### Java

* (image) [Java time classes](https://github.com/oh-jon-paul/awesome-i18n/blob/main/time-api.png) ⭐ 409 | 🐛 0 | 📅 2026-09-18 - table with date-time classes
...
* [SwiftGoogleTranslate](https://github.com/maximbilan/SwiftGoogleTranslate) ⭐ 101 | 🐛 0 | 🌐 Swift | 📅 2026-06-27 - framework to use cloud translation API by Google in Swift

### Ruby

* [Twitter/CLDR](https://github.com/twitter/twitter-cldr-rb) ⭐ 692 | 🐛 13 | 🌐 Ruby | 📅 2025-12-18 - ICU implementation that uses the CLDR to format dates, plurals
...
* [jekyll-multiple-languages-plugin](https://github.com/kurtsson/jekyll-multiple-languages-plugin) ⚠️ Archived - Jekyll Multiple Languages is an internationalization plugin
* (archived) [jekyll-i18n](https://github.com/liamzebedee/jekyll-i18n) ⭐ 39 | 🐛 4 | 🌐 Ruby | 📅 2019-04-09 - Jekyll i18n is a plugin that enables simplistic multi-language site designs

## 📅 Utilities

* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,283 | 🐛 121 | 🌐 C++ | 📅 2026-09-23 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,086 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - cross-platform app that automatically translate texts when copied
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,719 | 🐛 127 | 🌐 Python | 📅 2026-09-03 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,453 | 🐛 30 | 🌐 Java | 📅 2026-09-22 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,501 | 🐛 161 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
...
* [NRG](https://github.com/nanolaba/readme-generator) ⭐ 10 | 🐛 14 | 🌐 Java | 📅 2026-05-18 - template engine that generates multi-language markdowns
...
* [Shipi18n](https://github.com/Shipi18n/shipi18n) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-18 - ci linter for locale files: key/placeholder/plural checks + optional llm mistranslation pass; json, po, xliff, arb, xcstrings
...
* [GitHub: FormatJS example project](https://github.com/simplelocalize/simplelocalize-react-intl) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2024-12-02
* [GitHub: i18next example project](https://github.com/simplelocalize/simplelocalize-i18next) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-12
