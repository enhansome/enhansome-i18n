...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,896 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-25 - readable, automated, and optimized internationalization
...
* [typesafe-i18n](https://github.com/ivanhofer/typesafe-i18n) ⭐ 2,477 | 🐛 42 | 🌐 TypeScript | 📅 2026-03-22 - type-safe, lightweight localization library for TypeScript with no external dependencies
...
* [next-intl](https://github.com/amannn/next-intl) ⭐ 4,372 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-24 - minimal solution for internationalization in Next.js
...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,064 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-25 - component translation for Next.js with SSR/SSG
...
* [react-i18nify](https://github.com/sealninja/react-i18nify) ⭐ 153 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-21 - simple i18n translation and localization components and helpers for React
...
* (Angular) [ngx-translate](https://github.com/ngx-translate/core) ⭐ 4,661 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-23 - i18n for Angular
* (VueJS) [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,713 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-25 - i18n for VueJS
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,282 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-25 - i18n for Angular
* (Svelte) [svelte-i18n](https://github.com/kaisermann/svelte-i18n) ⭐ 1,378 | 🐛 74 | 🌐 TypeScript | 📅 2024-10-21 - i18n for Svelte
* (Nuxt) [nuxt-i18n-micro](https://github.com/s00d/nuxt-i18n-micro) ⭐ 252 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - strategy-based i18n; @i18n-micro packages for vue/react/preact/solid/astro/node
* (Angular) [ng-extract-i18n-merge](https://github.com/daniel-sc/ng-extract-i18n-merge) ⭐ 222 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-24 - manage translation files for native Angular CLI i18n
...
[Add your links here](https://github.com/oh-jon-paul/awesome-i18n/issues/new) ⭐ 411 | 🐛 1 | 📅 2026-09-18

### Java

* (image) [Java time classes](https://github.com/oh-jon-paul/awesome-i18n/blob/main/time-api.png) ⭐ 411 | 🐛 1 | 📅 2026-09-18 - table with date-time classes
...
* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,287 | 🐛 120 | 🌐 C++ | 📅 2026-09-24 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,090 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - cross-platform app that automatically translate texts when copied
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,832 | 🐛 127 | 🌐 Python | 📅 2026-09-03 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,459 | 🐛 30 | 🌐 Java | 📅 2026-09-23 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,508 | 🐛 162 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
* [i18n-ally](https://github.com/antfu/i18n-ally) ⭐ 4,894 | 🐛 476 | 🌐 TypeScript | 📅 2024-12-13 - VS Code extension for i18n
