...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,882 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-18 - readable, automated, and optimized internationalization
...
* [BidiLens](https://github.com/CodeinScrubs/BidiLens) ⭐ 11 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14 - per-block rtl/ltr direction and inline isolation without rewriting source text
...
* [next-intl](https://github.com/amannn/next-intl) ⭐ 4,368 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-14 - minimal solution for internationalization in Next.js
...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,060 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-18 - component translation for Next.js with SSR/SSG
...
* [react-i18nify](https://github.com/sealninja/react-i18nify) ⭐ 154 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-18 - simple i18n translation and localization components and helpers for React
...
* (VueJS) [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,711 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-17 - i18n for VueJS
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,281 | 🐛 160 | 🌐 TypeScript | 📅 2026-09-18 - i18n for Angular
...
* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,276 | 🐛 120 | 🌐 C++ | 📅 2026-09-10 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,077 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - cross-platform app that automatically translate texts when copied
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,660 | 🐛 126 | 🌐 Python | 📅 2026-09-03 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,412 | 🐛 30 | 🌐 Java | 📅 2026-08-26 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,480 | 🐛 161 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
...
* [Shipi18n](https://github.com/Shipi18n/shipi18n) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-17 - ci linter for locale files: key/placeholder/plural checks + optional llm mistranslation pass; json, po, xliff, arb, xcstrings
