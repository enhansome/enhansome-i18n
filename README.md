...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,858 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-14 - readable, automated, and optimized internationalization
...
* [next-intl](https://github.com/amannn/next-intl) ⭐ 4,354 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-26 - minimal solution for internationalization in Next.js
...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,052 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-26 - component translation for Next.js with SSR/SSG
...
* (VueJS) [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,712 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-26 - i18n for VueJS
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,278 | 🐛 151 | 🌐 TypeScript | 📅 2026-08-22 - i18n for Angular
...
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 2,039 | 🐛 65 | 🌐 Python | 📅 2024-07-23 - library to translate between different languages in a simple way using multiple translators
...
* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,232 | 🐛 116 | 🌐 C++ | 📅 2026-08-26 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,053 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - cross-platform app that automatically translate texts when copied
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,134 | 🐛 125 | 🌐 Python | 📅 2026-08-23 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,354 | 🐛 26 | 🌐 C++ | 📅 2026-08-26 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,401 | 🐛 159 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
