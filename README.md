...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,850 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-14 - readable, automated, and optimized internationalization
...
* [next-intl](https://github.com/amannn/next-intl) ⭐ 4,349 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-19 - minimal solution for internationalization in Next.js
...
* [general translation](https://github.com/generaltranslation/gt) ⭐ 1,048 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-20 - component translation for Next.js with SSR/SSG
...
* (VueJS) [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,706 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-17 - i18n for VueJS
* (Angular) [transloco](https://github.com/jsverse/transloco) ⭐ 2,274 | 🐛 151 | 🌐 TypeScript | 📅 2026-08-20 - i18n for Angular
...
[Add your links here](https://github.com/oh-jon-paul/awesome-i18n/issues/new) ⭐ 408 | 🐛 4 | 📅 2026-07-24
...
* [Twitter/CLDR](https://github.com/twitter/twitter-cldr-rb) ⭐ 693 | 🐛 12 | 🌐 Ruby | 📅 2025-12-18 - ICU implementation that uses the CLDR to format dates, plurals
...
* (JS) [googlei18n/libphonenumber](https://github.com/googlei18n/libphonenumber) ⭐ 18,222 | 🐛 115 | 🌐 C++ | 📅 2026-08-13 - parsing, formatting, and validating phone numbers (Java, C++, JavaScript)
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,042 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - cross-platform app that automatically translate texts when copied
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,058 | 🐛 124 | 🌐 Python | 📅 2026-08-10 - self-hosted web application to translate texts
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,332 | 🐛 26 | 🌐 C++ | 📅 2026-08-17 - simultaneous translator app for Android based on Google's API
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,382 | 🐛 157 | 🌐 Python | 📅 2026-08-08 - open source offline translation app based on OpenNMT
